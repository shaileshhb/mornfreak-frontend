...
const FOOTER_GROUPS = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Science Behind It", href: "/about" },
...
export function Footer() {
  return (
    <footer className="border-t-4 border-primary bg-[#241510] text-[#f3e4ce]">
      <div className="mx-auto max-w-[90rem] px-4 py-14 sm:px-6 sm:py-16 lg:px-10">
        <div className="grid gap-12 sm:grid-cols-2 lg:grid-cols-[1.1fr_0.9fr_0.9fr_0.9fr]">
          <div>
            <Link
              ...
              className="inline-block font-display text-4xl uppercase leading-none tracking-[0.06em] text-white transition-colors hover:text-primary"
            >
              Mornfreak
            </Link>
            <p className="mt-4 max-w-xs text-sm leading-relaxed text-[#f3e4ce]/65">
            ...
            <a
              ...
              className="mt-6 inline-flex h-10 w-10 items-center justify-center rounded-full bg-primary text-white transition-transform hover:-translate-y-0.5"
            >
              <InstagramIcon />
            </a>
          </div>
              ...
              <ul className="mt-5 space-y-3">
                {group.links.map((link) => (
                  <li key={link.label}>
                    <Link
                      href={link.href}
                      className="font-sans text-sm text-[#f3e4ce]/70 transition-colors hover:text-white"
                    >
                      {link.label}
                    </Link>
                  </li>
        ...
        <div className="mt-14 flex flex-wrap items-center justify-between gap-4 border-t border-white/10 pt-6 text-[0.65rem] uppercase tracking-[0.12em] text-[#f3e4ce]/45">
