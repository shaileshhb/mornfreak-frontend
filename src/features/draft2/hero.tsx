...
const HERO_BENEFITS = [
  { label: "26g Protein", detail: "Per Serving", icon: Dumbbell },
  { label: "Prebiotics Added", detail: "Gut Friendly", icon: Sprout },
  { label: "Sustained Energy", detail: "Complex Carbs & Fiber", icon: BatteryCharging },
  { label: "Super Seeds & Nuts", detail: "Omega-3 & Nutrient Rich", icon: Leaf },
] as const;
  ...
  return (
    ...
    >
      <div className="absolute inset-y-0 right-0 w-full lg:w-[58%]">
        <Image
          src="/images/draft2/hero.jpg"
          alt="Mornfreak Rich Chocolate Protein Oats pouch with chocolate splash, oats and nuts"
          fill
          priority
          sizes="(max-width: 1024px) 100vw, 58vw"
          className="animate-ken-burns object-cover object-[center_right]"
        />
      </div>
          ...
          <div className="animate-rise flex flex-col">
            <div className="mb-5 flex items-center gap-3 text-white">
              ...
              <span className="font-sans text-xs font-bold uppercase tracking-[0.16em]">
                5.0 Stars <span className="mx-1 text-white/40">|</span> 10K+ Reviews
              </span>
            </div>
            <h1 className="max-w-xl font-display text-[clamp(4.25rem,9vw,8rem)] uppercase italic leading-[0.82] tracking-[0.01em] text-[#f5efe1]">
              Fuel your day.
            ...
            <p className="mt-6 max-w-xl font-sans text-base leading-relaxed text-white/75 sm:text-lg">
              Mornfreak Protein Oats combines the power of 26g protein, super seeds &amp; nuts, and
              prebiotics for a delicious, science-backed start.
            </p>
              ...
              {HERO_BENEFITS.map(({ label, detail, icon: Icon }) => (
                <div key={label} className="flex items-center gap-3 sm:block">
                  ...
                  <div>
                    ...
                    <p className="mt-0.5 font-sans text-[0.65rem] uppercase tracking-wide text-white/50">
                      {detail}
                    </p>
                  </div>
                </div>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Link
                ...
                className="inline-flex h-12 items-center justify-center gap-2 bg-[#f5efe1] px-7 font-sans text-sm font-bold uppercase tracking-[0.12em] text-[#241510] transition-transform hover:-translate-y-0.5"
              >
