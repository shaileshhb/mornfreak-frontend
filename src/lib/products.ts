...
export const PRODUCT_CONTENT: Record<ProductId, ProductContent> = {
  peanutButter: {
    ...
    shopifyHandle: "peanut-butter-powder",
  ...
  peanutButterPackOf2: {
    ...
    shopifyHandle: "peanut-butter-powder-pack-of-2",
    label: "Peanut Butter Powder",
    tagline: "Clean Fuel. Real Results.",
    images: [
  ...
  proteinOats425gPackOf2: {
    ...
    shopifyHandle: "protein-oats-425g-pack-of-2",
  ...
  proteinOats77g: {
    ...
    shopifyHandle: "protein-oats-77g",
  ...
  proteinOats77gPackOf6: {
    ...
    shopifyHandle: "protein-oats-77g-pack-of-6",
